/**
 * Managed Lists Documentation
 * 
 * Public documentation page for Managed Lists feature
 */
...
export default function ManagedListsDocsPage() {
  return (
          ...
          <div className="space-y-12">
            ...
            <section className="space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <Card>
                  <CardContent className="pt-6">
                    <Link href="/docs/user-manual/super-admin" className="block space-y-2 hover:opacity-75 transition-opacity">
                ...
                <Card>
                  <CardContent className="pt-6">
                    <Link href="/docs" className="block space-y-2 hover:opacity-75 transition-opacity">
